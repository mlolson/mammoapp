...
function Finding() {
	 ...
	 function addPoint(x,y){
	  	...
	  	if(this.n > 2){
	  		if((Math.abs(this.xArr[0] - this.xArr[this.n]) + Math.abs(this.yArr[0] - this.yArr[this.n])) < 20/WS.zoomFactor){
...
function AnswerFinding(imgN,setN,findingNum,isCC,isMLO,xCC,yCC,xMLO,yMLO,type,description,
		corFinding,userType,userDescription,wasSubmitted) {	
	this.xCC= xCC;
	this.yCC= yCC;
	this.xMLO= xMLO;
	this.yMLO= yMLO;	

public class SplayTreeBST<Key extends Comparable<Key>, Value>  {
    ...
    *************************************************************************/
    ...
    public static void main(String[] args) {
        SplayTreeBST<Integer, Integer> st1 = new SplayTreeBST<Integer, Integer>();
        st1.put(5, 5);
        st1.put(9, 9);
        st1.put(13, 13);
        st1.put(11, 11);
        ...
        SplayTreeBST<String, String> st = new SplayTreeBST<String, String>();
